              ...
              {DATA.hackathons.map((project, id) => (
                ...
                >
                  <HackathonCard
                    ...
                    description={"I am developing a cross-platform mobile application designed to improve navigation within railway stations for visually impaired individuals. This app aims to provide real-time guidance and assistance, utilizing features such as audio prompts, tactile maps, and location-based services to help users easily navigate the station environment. By enhancing accessibility, the application seeks to empower visually impaired people, ensuring they can travel confidently and independently within railway facilities."}
